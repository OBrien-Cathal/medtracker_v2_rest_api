create type USER_ROLE as enum ('USER', 'PATIENT', 'PRACTITIONER','ADMIN' );
create type DAYSTAGE as enum ('WAKEUP', 'MORNING','MIDDAY','AFTERNOON','EVENING','NIGHT','BEDTIME' );
...
(
    id                BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    USERMODEL_ID      BIGINT    NOT NULL UNIQUE ,
    foreign key (userModel_id) references userModel (id),
